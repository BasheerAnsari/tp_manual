...
from core_services.app.schemas.candidate_schema import CandidateSignupSchema, CandidateProfileUpdateSchema
from core_services.app.services.candidate_services import candidate_signup_service, candidate_profile_update_service
